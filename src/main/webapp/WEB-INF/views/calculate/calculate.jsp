...
<header id="calculate_header">
    <div id="calculate_title">
        <%--왼쪽 화살표--%>
        <a href="/storenotice1" onclick="location.href='/storenotice1'"><i class="fas fa-solid fa-arrow-left"
    ...
    <table id="calculate_date">
        ...
        <tr>
            ...
            <%--오른쪽 화살표--%>
            <td>
                <a class="go-next"><i id="calculate_search_rightArrow" class="fas fa-solid fa-angle-right"
