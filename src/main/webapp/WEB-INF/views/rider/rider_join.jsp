...
<head>
    ...
    <script src="../../js/rider/rider_join.js"></script>
</head>
<style>
    /* 추가된 CSS 스타일 */
    .container {
    ...
    <form action="/rider_join" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
        <div class="form_field">
            ...
            <div class="input_container">
                <input type="text" id="id" name="riderId" required>
        ...
        <div class="form_field">
            ...
            <input type="password" id="password" name="riderPassword" required>
        ...
        <div class="form_field">
            ...
            <input type="text" id="name" name="riderName" required>
        </div>

        <div class="form_field">
            <label for="phone">휴대폰</label>
            <input type="tel" id="phone" name="riderPhone" required>
        ...
        <div class="form_field">
            ...
            <div class="input_container">
                <input type="text" id="address_kakao" name="riderAddress" readonly>
                <div class="btn_container">
...
<script>
    ...
    function checkDuplicate() {
        // 아이디의 값을 받아온다.
        var riderId = document.getElementById("id").value;
        // 아이디 받은 값을 userId에 값을 넣어가지고 userId/{userId}/exists 컨트롤러로 이동
        var url = "/riderId/" + riderId + "/exists";
