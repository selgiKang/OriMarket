...
<body>
    ...
    <div id="container">
        <form action="/login" method="post" onsubmit="return validateLoginForm();">
            ...
            <div id="login_box">
                <div>
                    <p>id: <input type="text" size="20" placeholder=" 아이디를 입력해주세요.." name="userId" id="userId" required></p>
                    <p>pw: <input type="password" size="20" placeholder=" *********" name="userPassword" id="userPassword" required></p>
                </div>
