        ...
        <div id="main_wrap_box">
            ...
            <div id="connextion_market" class="clear">
                ...
                <div class="connextion_marketbox clear">
                    <div class="connextion_mk1_wrap"><a class="connextion_mk1" href="/shinwon_marketmap?marketName=신원시장"><p style="font-weight: 800;">신림<br><input type="text" name="m" value="신원시장"></p></a><p style="font-size: 10px;">　</p></div>
