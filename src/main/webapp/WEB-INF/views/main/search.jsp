...
<style>
    ...
    /* 230724 승원 */
    div.search_wrap{width: 90%; height:512px; position:relative; border-radius: 25px; border-radius: 25px; background-color:#fff; padding:20px 5px; margin:auto; box-shadow: 0px 2px 8px rgba(0, 0, 0, 0.5);}
    ...
    <div class="search_wrap">
        <form action="/search" method="post">
            <div class="form_field">
                ...
                <h2 style="position: absolute; top: 1px; left: 25%;"><label for="address_kakao">배달받을 주소 설정하기</label></h2>
                <c:if test="${!empty userAddress1}">
                    <a href="/mylocation" class="mylocation_btn">위치보기</a>
                    <p style="position: absolute;width: 280px;top: 12%;left: 5px;padding: 10px 29px;">현재 내가 설정한주소: <span style="color: #46A973;">${userAddress1} ${userAddressDetail1}</span></p>
                </c:if>
                <c:if test="${empty userAddress1}">
                ...
                <div class="input_container">
                    <input type="text" id="address_kakao" name="userAddress1" readonly style="position: absolute; top: 35%; right: 30%;" placeholder="주소검색버튼을눌러주세요..">
