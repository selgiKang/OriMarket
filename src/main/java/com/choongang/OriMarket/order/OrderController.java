...
public class OrderController {
    ...
    //특정 날짜 정보
    @GetMapping("/details")
    public String showDetailsPage(@RequestParam("orderNumber") String orderNumber, Model model) {
    ...
    public String pastOrderDetailList(@RequestParam("orderNumber") String orderNumber, Model model) {
