...
public class RiderService {
    ...
    public boolean riderJoin(Rider rider, HttpSession session, String s) {
        ...
        if (riderRepository.findByDriverLicense(rider.getDriverLicense()) != null) {
            return false;
        }
    ...
    public NewOrder riderOrderAccept1(String orderNumber) {
        NewOrder byOrderNumber = newOrderRepository.findByOrderNumber(orderNumber);
    ...
    public List<NewOrder> riderOrderAccept2(String orderNumber) {
        NewOrder byOrderNumber = newOrderRepository.findByOrderNumber(orderNumber);
